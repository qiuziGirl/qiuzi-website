...
| :--------: | :---------: | :--------------: | :--------------: | :--------------: | :----------: | :------: |
| 选择 | Selection | n<sup>2</sup>   |      n<sup>2</sup>   |    n<sup>2</sup>    | 1 | 不稳 |
| 冒泡 | Bubble    |                n<sup>2</sup>|    n<sup>2</sup>            | n | 1 | 稳 |
| 插入 | Insertion |                n<sup>2</sup>|                n<sup>2</sup>| n | 1 | 稳 |
| 快速 | Quick     | n log<sub>2</sub> n | n<sup>2</sup> |                n log<sub>2</sub> n|  log<sub>2</sub> n| 不稳 |
| 归并 | Merge     |                n log<sub>2</sub> n|                n log<sub>2</sub> n|                n log<sub>2</sub> n| n | 稳 |
| 堆   | Heap      |                n log<sub>2</sub> n|                n log<sub>2</sub> n|                n log<sub>2</sub> n| 1 | 不稳 |
| 希尔 | Shell     | n<sup>1.3</sup> |     n<sup>2</sup>   | n | 1 | 不稳 |
| 桶   | Bucket    | n + k |     n<sup>2</sup>| n | n + k | 稳 |
| 计数 | Counting  | n + k | n + k | n + k | n + k | 稳 |
| 基数 | Radix     | n * k | n * k | n * k | n + k | 稳 |

口诀：<br>
选泡插，快归堆希统计姬；n 方 n 老 n 一三，对 n 加 k n 乘 K；不稳稳稳不稳稳，不稳不稳稳稳稳。
